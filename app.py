...
def init_db():
    ...
    crops = [
        ("Rice", "An important cereal crop grown mainly in warm and humid conditions.",
         ...
         "Clay or loamy soil", "5.5-6.5", "Kharif", "June-July",
         "October-November", "NPK fertilizer and organic manure",
         "Food, flour and animal feed",
         "Use healthy seed, proper irrigation and balanced fertilizer"),

        ("Wheat", "An important winter cereal crop.", "Triticum aestivum",
         "Cool and dry", "10-25°C", "450-650 mm", "Loamy soil", "6.0-7.5",
         "Rabi", "October-November", "March-April",
         "NPK fertilizer and nitrogen", "Flour, bread and animal feed",
         "Use resistant varieties and healthy seed"),

        ("Tomato", "An important vegetable crop grown in many regions.",
         "Solanum lycopersicum", "Warm", "18-30°C", "600-1200 mm",
         "Loamy soil", "6.0-7.0", "Kharif/Rabi",
         "June-July or September-October",
         "September-November or January-March",
         "NPK fertilizer and organic manure", "Vegetables, sauces and juice",
        ...
        ("Potato", "An important tuber crop grown mainly during cool weather.",
         "Solanum tuberosum", "Cool", "15-20°C", "500-700 mm",
         "Sandy loam soil", "5.0-6.5", "Rabi", "October-November",
         "January-February", "NPK fertilizer and organic manure",
    ...
    symptoms = [
        ...
        "Dark leaf spots", "Water-soaked lesions", "Fruit lesions",
        "Leaf curling", "Stunted growth", "Long gray-green lesions",
        "Leaf spots", "Reddish-brown pustules", "Concentric leaf spots",
    ...
    diseases = [
        ...
        ("Rice", "Brown Spot",
         ...
         "Use clean seed and balanced fertilizer.", "Moderate"),

        ("Wheat", "Wheat Rust",
         "Orange pustules, yellowing leaves", "Fungus",
         "Use recommended fungicides.",
         "Use resistant varieties and healthy seed.", "High"),

        ("Wheat", "Powdery Mildew",
         "White powder on leaves, yellowing leaves", "Fungus",
         "Use recommended fungicides.",
         "Use resistant varieties and good field ventilation.", "Moderate"),

        ("Tomato", "Early Blight",
         "Dark leaf spots, yellowing leaves", "Fungus",
         "Use recommended fungicides and remove severely infected leaves.",
         "Use healthy seedlings and maintain field hygiene.", "Moderate"),
        ...
        ("Tomato", "Late Blight",
         ...
         "Maintain good drainage and air circulation.", "High"),

        ("Tomato", "Tomato Leaf Curl",
         "Leaf curling, yellowing leaves, stunted growth", "Virus",
         "Control insect vectors and remove severely infected plants.",
         "Use healthy seedlings and control whiteflies.", "High"),

        ("Maize", "Northern Corn Leaf Blight",
         "Long gray-green lesions, leaf spots", "Fungus",
         "Use recommended fungicides.",
         "Use resistant hybrids and healthy seed.", "Moderate"),

        ("Maize", "Common Rust",
         "Reddish-brown pustules, yellowing leaves", "Fungus",
         "Use recommended fungicides.",
         "Use resistant varieties.", "Moderate"),

        ("Potato", "Potato Early Blight",
         "Brown spots, concentric leaf spots", "Fungus",
         "Use recommended fungicides.",
         "Use healthy seed and proper crop rotation.", "Moderate"),

        ("Potato", "Potato Late Blight",
         "Water-soaked lesions, dark leaf spots, tuber lesions",
         "Fungus-like pathogen",
         "Use recommended fungicides and remove infected plant material.",
         "Use healthy seed and maintain good drainage.", "High"),

        ("Potato", "Potato Bacterial Wilt",
         "Plant wilting, yellowing leaves, stunted growth", "Bacteria",
    ...
    connections = {
        ...
        "Wheat Rust": ["Orange pustules", "Yellowing leaves"],
        "Powdery Mildew": ["White powder on leaves", "Yellowing leaves"],
        "Early Blight": ["Dark leaf spots", "Yellowing leaves"],
        "Late Blight": ["Water-soaked lesions", "Dark leaf spots", "Fruit lesions"],
        "Tomato Leaf Curl": ["Leaf curling", "Yellowing leaves", "Stunted growth"],
        "Northern Corn Leaf Blight": ["Long gray-green lesions", "Leaf spots"],
        "Common Rust": ["Reddish-brown pustules", "Yellowing leaves"],
        "Potato Early Blight": ["Brown spots", "Concentric leaf spots"],
        "Potato Late Blight": ["Water-soaked lesions", "Dark leaf spots", "Tuber lesions"],
        "Potato Bacterial Wilt": ["Plant wilting", "Yellowing leaves", "Stunted growth"]
    }
...
def disease_detail(disease_id):
    ...
    return render_template(
        ...
        disease=disease,
        symptoms=symptoms,
        image_name=image_map.get(disease["name"], "default.jpg")
    )
...
def crop_details(crop_id):
    ...
    crop = conn.execute("""
        SELECT name, description, scientific_name, climate, temperature,
